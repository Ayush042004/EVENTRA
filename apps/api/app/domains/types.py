...
from app.models.enums import EventType, DependencyType, TaskPriority
...
class RequirementDefinition(BaseModel):
    ...
    key: str = Field(..., description="Unique stable key for the requirement, e.g. 'wedding.catering'")
...
class TaskDefinition(BaseModel):
    ...
    priority: TaskPriority = Field(default=TaskPriority.MEDIUM, description="Operational priority")
